##################
# Monitor: GetControlSessionIDs* (254988)
# Interval: 300 seconds
# Alert Mode: Send Fail after Success
# Alert Template: Default - Do Nothing
# Alert Script: No script selected
# Ticket Category: No category selected
#
# Targeted Groups:
# Global Monitor. No groups targeted.
#
# Last Modified by dwhite@automate.apextmi.com
# Last Run - 2019-02-16 07:17:34
##################
